...
public class PersistentProperty {
	...
	public PersistentProperty(String street, String number, Point location, Polygon reachableRange) {
		this.street = street;
		this.number = number;
	...
	public static PersistentProperty of(String street, String number, Point location, Polygon reachableRange) {
