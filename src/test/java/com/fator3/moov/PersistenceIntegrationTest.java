...
public class PersistenceIntegrationTest extends AbstractIntegrationTest {
	...
	public void shouldPersistSomeProperty() throws ParseException {
		...
		final PersistentProperty property = PersistentProperty.of(STREET, NUMBER, location, polygon);
	...
	private List<LatLng> makeSquare() {
		...
		final List<LatLng> points = Lists.newArrayList(LatLng.of(location1), LatLng.of(location2), LatLng.of(location3),
				LatLng.of(location4), LatLng.of(location5));
